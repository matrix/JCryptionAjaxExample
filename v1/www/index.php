...
<head>
	...
	<script type="text/javascript" src="js/jquery.jcryption.1.2.js"></script>
	...
	{
		$.jCryption.getKeys("actions.php?generateKeypair=true",function(k) {
			keys = k;
...
?>
		...
		$("#submitLogin").click(function() {
			...
			$.jCryption.encrypt(dataString, keys, function(x) {
				var encryptedString = x;
		...
		$("#submitSetData").click(function() {
			...
			$.jCryption.encrypt(dataString, keys, function(x) {
				var encryptedString = encodeURIComponent(x);
