...
class JCryption
{
    ...
    public static function decryptPost()
    {
        self::session_start();
    ...
    public static function decryptGet()
    {
        self::session_start();
        parse_str(sqAES::decrypt($_SESSION[self::SESSION_KEY], $_GET[self::POST_KEY]), $_GET);
        //Can't unset the key here, it breaks bi-directional.
        //unset($_SESSION[self::SESSION_KEY]);
        unset($_REQUEST[self::POST_KEY]);
